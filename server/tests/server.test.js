...
describe('PATCH /todos/:todo_id', ()=>{
  ...
  describe('POST /users', ()=>{
    it('should create a user', (done)=>{
      let email = `example@notanemailaddress.com`;
      let password = `superman123`;
    ...
    it('should not create a user with the same email as another user', (done)=>{
      let email = `casey@notanemailaddress.com`;
      let password = `superman123`;
      let username = `casey`;
  ...
  describe('DELETE /users/me/token', ()=>{
    it('should delete token of the authorized user', (done)=>{
      request(app)
